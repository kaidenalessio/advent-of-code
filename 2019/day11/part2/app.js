...
canvas.width = 50 * pixelRatio;
canvas.height = 10 * pixelRatio;

const colors = ['#000', '#fff'];

for (let i = 0; i < robot.paintings.length; i++) {
	const x = robot.paintings[i].x;
	const y = robot.paintings[i].y;
	ctx.fillStyle = colors[robot.paintings[i].color];
